...
const GSC: TypeChart = extend(true, {}, RBY, {
  '???': {Dark: 1, Steel: 1},
  Normal: {Dark: 1, Steel: 2},
  Grass: {Dark: 1, Steel: 2},
  Fire: {Dark: 1, Steel: 0.5},
  Water: {Dark: 1, Steel: 1},
  Electric: {Dark: 1, Steel: 1},
  Ice: {Fire: 2, Dark: 1, Steel: 2},
  Flying: {Dark: 1, Steel: 2},
  Bug: {Poison: 2, Dark: 0.5, Steel: 2},
  Poison: {Bug: 1, Dark: 1, Steel: 2},
  Ground: {Dark: 1, Steel: 0.5},
  Rock: {Dark: 1, Steel: 2},
  Fighting: {Dark: 0.5, Steel: 0.5},
  Psychic: {Dark: 2, Steel: 2},
  Ghost: {Psychic: 0.5, Dark: 2, Steel: 2},
  Dragon: {Dark: 1, Steel: 2},
  Dark: {
    '???': 1,
    Normal: 1,
    Grass: 1,
